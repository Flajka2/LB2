...
/*        List<Integer> arrayList = new ArrayList<>();
        ...
        *//*для записи значения set(i,100)
        ...
        user.add(new User("Ruslan","nick1", 20));
        user.add(new User("Max","nick2",19));
        user.add(new User("Bogdan","nick3",19));

        System.out.println(user);

        user.remove(new User("Ruslan","nick1", 20));

        System.out.println(user);
        System.out.println(user.contains(new User("Bogdan","nick3",19)) +" "+ user.contains(new User("Ruslan","nick1", 20)));
        ...
        System.out.println("Есть ли Михаил: " +  student.contains(new Student("Михаил", "Зубенко","ЕСТМ-19-1",2)));
